...
return {
  ...
  -- { -- Diff preview for AI coding agent edits (Claude Code)
  ...
  --         },
  --         highlights = {
  --           modified = { fg = '#dcdcaa', bold = true },
  --           created = { fg = '#6a9955', bold = true },
  --           deleted = { fg = '#f44747', bold = true, strikethrough = true },
  --         },
  --       },
  --     }
  --   end,
  ...
  { -- Test runner
    ...
    keys = {
      { '<leader>nt', function() require('neotest').run.run() end, desc = 'Neotest: Run nearest' },
      { '<leader>nf', function() require('neotest').run.run(vim.fn.expand '%') end, desc = 'Neotest: Run file' },
      { '<leader>ns', function() require('neotest').run.run { suite = true } end, desc = 'Neotest: Run suite' },
      { '<leader>nl', function() require('neotest').run.run_last() end, desc = 'Neotest: Run last' },
      { '<leader>no', function() require('neotest').output.open { enter = true } end, desc = 'Neotest: Show output' },
